...
add_action( 'customize_register', 'seo_writers_blogily_customize_register', 9999999 );
...
if(! function_exists('seo_writers_blogily_customize_register_output' ) ):
	function seo_writers_blogily_customize_register_output(){
		...
		<style type="text/css">
			...
			.site-title a, .site-description {color: #<?php echo esc_attr(get_theme_mod( 'header_textcolor')); ?> !important; }
